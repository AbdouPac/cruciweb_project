<?php
session_start();
include_once '../controleur/fonctions.php';
    ...
    <body>
        ...
        <form action="../controleur/creerGrille.php" method="post" id="formGrille" onsubmit="submitForm()">
            ...
            <div id="partie2" class="d-none">
                ...
                <p class="info">Cliquez sur une case pour la remplir. <b>Vous pouvez également mettre # pour des cases noires de sépparation</b>.</p>
